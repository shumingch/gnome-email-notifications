...
2. Install `gir1.2-goa` e.g. 

```bash
sudo apt install gir1.2-goa-1.0
```

3. Sign in with your Google and/or Microsoft account in Gnome Online Accounts settings.

4. Either install from https://extensions.gnome.org/extension/1230/gmail-message-tray/
OR
...
2. To see logs, enter `journalctl | grep "Gnome Email Notification"`  or `journalctl | grep GmailMessageTray` into terminal. 
